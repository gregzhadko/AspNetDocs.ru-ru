...
3. Unzip загрузки.
4. Добавьте ссылку на сборку Moq, нажав на папку Ссылки в проекте ContactManager.Tests и выбрав **справку Add.** Под вкладкой «Обзор» просмотрите папку, где расстегнули Moq, и выберите сборку Moq.dll. Нажмите кнопку **ОК**.
5. После выполнения этих шагов папка «Ссылки» должна выглядеть как рисунок 2.

[![Разблокирование Moq](iteration-5-create-unit-tests-cs/_static/image1.jpg)](iteration-5-create-unit-tests-cs/_static/image1.png)

**Рисунок 01**: Разблокировка Moq[(Нажмите, чтобы посмотреть полноразмерное изображение](iteration-5-create-unit-tests-cs/_static/image2.png))
...
**Рисунок 02**: Ссылки после добавления Moq[(Нажмите, чтобы просмотреть полноразмерное изображение](iteration-5-create-unit-tests-cs/_static/image4.png))
...
[![Модели-КонтактМенеджерСервисТест.cs](iteration-5-create-unit-tests-cs/_static/image3.jpg)](iteration-5-create-unit-tests-cs/_static/image5.png)

**Рисунок 03**: Модели»ContactManagerServiceTest.cs[(Нажмите, чтобы просмотреть полноразмерное изображение](iteration-5-create-unit-tests-cs/_static/image6.png))
...
**Список 1 - Модели/ContactManagerServiceTest.cs**
...
[![Результаты тестирования](iteration-5-create-unit-tests-cs/_static/image4.jpg)](iteration-5-create-unit-tests-cs/_static/image7.png)

**Рисунок 04**: Результаты испытаний[(Нажмите, чтобы просмотреть полноразмерное изображение)](iteration-5-create-unit-tests-cs/_static/image8.png)

## <a name="creating-unit-tests-for-controllers"></a>Создание модульных тестов для контроллеров

Приложение ASP.NETMVC контролирует поток пользовательского взаимодействия. При тестировании контроллера необходимо проверить, возвращает ли контроллер нужный результат действия и просматривать данные. Также можно проверить, взаимодействует ли контроллер с классами моделей в ожидаемом порядке.
