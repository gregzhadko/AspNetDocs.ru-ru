...
**Листинг 1 - Модели-IContactManagerRepository.vb**
...
**Список 2 - Модели-EntityContactManagerRepository.vb**
...
**Список 4 - Модели/ContactManagerService.vb**
...
**Список 5 - Модели-IContactManagerService.vb**
...
**Список 6 - Контролеры/КонтактКонтроллер.vb**
...
**Список 7 - Модели (Проверка) ModelStateWrapper.vb**

[!code-vb[Main](iteration-4-make-the-application-loosely-coupled-vb/samples/sample7.vb)]

**Список 8 - Модели (Проверка) - IValidationDictionary.vb**
